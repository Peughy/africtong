...
class QuestionBotController{
  List<QuestionBotModel> questions =  const [
    QuestionBotModel(question: question_1),
    QuestionBotModel(question: question_2),
    QuestionBotModel(question: question_3),
    QuestionBotModel(question: question_4),
    QuestionBotModel(question: question_5),
  ];
}